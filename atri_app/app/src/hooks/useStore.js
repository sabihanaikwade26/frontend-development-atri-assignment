...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image87": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616da2c3a1718503bfe60f49_location-icon-restaurante-x-template%20(1).svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image88": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616da2c36165d583fe91702b_phone-icon-restaurante-x-template%20(1).svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image89": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/616da2c3400864a9087440a4_email-icon-restaurante-x-template%20(1).svg"
      },
      "callbacks": {
        "onClick": [
          {
